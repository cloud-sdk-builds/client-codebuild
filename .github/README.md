...
[`@aws-sdk/client-codebuild`](https://www.npmjs.com/package/@aws-sdk/client-codebuild/v/3.864.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codebuild@3.864.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vmXyH6J/CgiJaej0FHIGGizMeAaelN0rytLM+L8ifRHlFeCy9tFa6C2hmPgJs5lx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-codebuild": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codebuild@3.864.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codebuild@3.864.0/index.min.mjs": "sha384-vmXyH6J/CgiJaej0FHIGGizMeAaelN0rytLM+L8ifRHlFeCy9tFa6C2hmPgJs5lx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-codebuild/blob/refs/tags/3.864.0/LICENSE
```
