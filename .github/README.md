...
[`@aws-sdk/client-codebuild`](https://www.npmjs.com/package/@aws-sdk/client-codebuild/v/3.872.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codebuild@3.872.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8CIve+ojKtO0glChQ+/N7wJCJDPmOjRuuBmIh0gfovza7UA+vSSKVLeg7nn4z9So
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-codebuild": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codebuild@3.872.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codebuild@3.872.0/index.min.mjs": "sha384-8CIve+ojKtO0glChQ+/N7wJCJDPmOjRuuBmIh0gfovza7UA+vSSKVLeg7nn4z9So"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-codebuild/blob/refs/tags/3.872.0/LICENSE
```
