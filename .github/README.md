...
[`@aws-sdk/client-codebuild`](https://www.npmjs.com/package/@aws-sdk/client-codebuild/v/3.549.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codebuild@3.549.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+jQzNDOxtQm0l50vevsOI+XG673H13LA5kraCED5bAg3jErOwdfLrSDByePPX1py
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-codebuild": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codebuild@3.549.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-codebuild@3.549.0/index.min.mjs": "sha384-+jQzNDOxtQm0l50vevsOI+XG673H13LA5kraCED5bAg3jErOwdfLrSDByePPX1py"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-codebuild/blob/refs/tags/3.549.0/LICENSE
```
